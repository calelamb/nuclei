...
export const GATE_REGISTRY: Record<string, GateInfo> = {
  H: {
    ...
    paramCount: 0,
    matrix: '1/√2 [[1, 1], [1, -1]]',
    frameworkNames: { qiskit: 'qc.h(q)', cirq: 'cirq.H(q)', 'cuda-q': 'h(q)', qsharp: 'H(q)' },
  },
  X: {
    canonical: 'X',
    displayName: 'Pauli-X',
    ...
    paramCount: 0,
    matrix: '[[0, 1], [1, 0]]',
    frameworkNames: { qiskit: 'qc.x(q)', cirq: 'cirq.X(q)', 'cuda-q': 'x(q)', qsharp: 'X(q)' },
  },
  Y: {
    canonical: 'Y',
    displayName: 'Pauli-Y',
    ...
    paramCount: 0,
    matrix: '[[0, -i], [i, 0]]',
    frameworkNames: { qiskit: 'qc.y(q)', cirq: 'cirq.Y(q)', 'cuda-q': 'y(q)', qsharp: 'Y(q)' },
  },
  Z: {
    canonical: 'Z',
    displayName: 'Pauli-Z',
    ...
    paramCount: 0,
    matrix: '[[1, 0], [0, -1]]',
    frameworkNames: { qiskit: 'qc.z(q)', cirq: 'cirq.Z(q)', 'cuda-q': 'z(q)', qsharp: 'Z(q)' },
  },
  S: {
    canonical: 'S',
    displayName: 'S Gate',
    ...
    paramCount: 0,
    matrix: '[[1, 0], [0, i]]',
    frameworkNames: { qiskit: 'qc.s(q)', cirq: 'cirq.S(q)', 'cuda-q': 's(q)', qsharp: 'S(q)' },
  },
  T: {
    canonical: 'T',
    displayName: 'T Gate',
    ...
    paramCount: 0,
    matrix: '[[1, 0], [0, e^(iπ/4)]]',
    frameworkNames: { qiskit: 'qc.t(q)', cirq: 'cirq.T(q)', 'cuda-q': 't(q)', qsharp: 'T(q)' },
  },
  RX: {
    canonical: 'RX',
    ...
    qubitCount: 1,
    paramCount: 1,
    frameworkNames: { qiskit: 'qc.rx(θ, q)', cirq: 'cirq.rx(θ)(q)', 'cuda-q': 'rx(θ, q)', qsharp: 'Rx(θ, q)' },
  },
  RY: {
    canonical: 'RY',
    ...
    qubitCount: 1,
    paramCount: 1,
    frameworkNames: { qiskit: 'qc.ry(θ, q)', cirq: 'cirq.ry(θ)(q)', 'cuda-q': 'ry(θ, q)', qsharp: 'Ry(θ, q)' },
  },
  RZ: {
    canonical: 'RZ',
    ...
    qubitCount: 1,
    paramCount: 1,
    frameworkNames: { qiskit: 'qc.rz(θ, q)', cirq: 'cirq.rz(θ)(q)', 'cuda-q': 'rz(θ, q)', qsharp: 'Rz(θ, q)' },
  },
  CNOT: {
    canonical: 'CNOT',
    ...
    qubitCount: 2,
    paramCount: 0,
    frameworkNames: { qiskit: 'qc.cx(c, t)', cirq: 'cirq.CNOT(c, t)', 'cuda-q': 'cx(c, t)', qsharp: 'CNOT(c, t)' },
  },
  CZ: {
    canonical: 'CZ',
    ...
    qubitCount: 2,
    paramCount: 0,
    frameworkNames: { qiskit: 'qc.cz(c, t)', cirq: 'cirq.CZ(c, t)', 'cuda-q': 'cz(c, t)', qsharp: 'CZ(c, t)' },
  },
  SWAP: {
    canonical: 'SWAP',
    displayName: 'SWAP',
    ...
    qubitCount: 2,
    paramCount: 0,
    frameworkNames: { qiskit: 'qc.swap(q1, q2)', cirq: 'cirq.SWAP(q1, q2)', 'cuda-q': 'swap(q1, q2)', qsharp: 'SWAP(q1, q2)' },
  },
  Toffoli: {
    canonical: 'Toffoli',
    ...
    qubitCount: 3,
    paramCount: 0,
    frameworkNames: { qiskit: 'qc.ccx(c1, c2, t)', cirq: 'cirq.TOFFOLI(c1,c2,t)', 'cuda-q': 'x.ctrl(c1, c2, t)', qsharp: 'CCNOT(c1, c2, t)' },
  },
  Measure: {
    canonical: 'Measure',
    ...
    qubitCount: 1,
    paramCount: 0,
    frameworkNames: { qiskit: 'qc.measure(q, c)', cirq: 'cirq.measure(q)', 'cuda-q': 'mz(q)', qsharp: 'M(q)' },
  },
};
