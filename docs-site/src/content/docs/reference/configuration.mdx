---
title: "Configuration"
description: "Where Nuclei stores state — settings.json, WebView localStorage, ~/.nuclei, the OS keyring — plus every environment variable and the kernel port."
---
...
The [Dirac](/docs/dirac/architecture/) API key is stored in **plaintext WebView localStorage** under the
