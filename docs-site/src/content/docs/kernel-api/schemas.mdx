---
title: "Schemas"
description: "Field-by-field reference for CircuitSnapshot, Gate, SimulationResult, BackendInfo, and JobHandle — including bitstring-key conventions per framework."
---
